...
export function FinalCTA({ onOpenModal }) {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative isolate py-20 md:py-32 lg:py-44 px-4 sm:px-6 bg-black overflow-hidden"
    >
      <div className="absolute inset-0 z-0 bg-gradient-to-b from-black via-black to-neutral-950 pointer-events-none" />
      ...
      >
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white tracking-tight leading-tight mb-6">
          READY TO GAIN EARLY ACCESS?
        </h2>
        <p className="text-base sm:text-lg text-white/40 mb-10 max-w-lg mx-auto">
          Spots for our upcoming beta cohort are strictly limited.
        </p>
        <button
          ref={buttonRef}
          type="button"
          ...
          className="btn-glow-invert relative z-[100] isolate inline-flex items-center px-8 py-4 rounded-md text-sm font-medium tracking-wide text-white bg-black border border-white/20 hover:border-white/40 transition-all duration-400 pointer-events-auto"
        >
